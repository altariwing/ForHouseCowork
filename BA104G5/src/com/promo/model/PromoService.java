...
public class PromoService {
	...
	public PromoVO add(java.sql.Date promo_from, java.sql.Date promo_to, String promo_name, String promo_content,
			byte[] promo_photo, String promo_state, String emp_no,Integer coupon_quanity) {
		...
		promoVO.setCoupon_quanity(coupon_quanity);
		dao.insert(promoVO);
		return promoVO;	
	}
	...
	public PromoVO update(java.sql.Date promo_from, java.sql.Date promo_to, String promo_name, String promo_content,
			byte[] promo_photo, String promo_state, String promo_no, String emp_no,Integer coupon_quanity) {
		PromoVO promoVO = new PromoVO();
		promoVO.setPromo_from(promo_from);
		promoVO.setPromo_to(promo_to);
		promoVO.setPromo_name(promo_name);
	...
	public void updateCoupon_quanity(Integer coupon_quanity,String promo_no){
		dao.updateCoupon_quanity(coupon_quanity, promo_no);
	}
