...
public class CouponVO implements Serializable {
	...
	public String transDiscountToHumanLanguage() {
		String human_language = "";
		String[] discount_datail = cp_discount.split(":");
		if (discount_datail[0].equals("percentDiscount")) {
			human_language = "單筆消費滿" + discount_datail[1] + "元打" + discount_datail[2] + "折";
		} else {
			human_language = "單筆消費滿" + discount_datail[1] + "元折" + discount_datail[2] + "元";
		}
