...
public class ResRecService {
	...
	public ResRecVO addResRec(String mem_no, String house_no, String rtr_no, String resr_states, Date resr_date,
			String resr_period, Double resr_hpric, Double resr_hsize, Double resr_mgt, Double resr_puc, Double resr_str,
			Double resr_wall, Double resr_ltg, Double resr_ven, Double resr_tc, Double resr_lc, String hse_rev,
			Double mem_rate, String mem_rev, Double rtr_rate) {
	...
	public ResRecVO updateResRec(String resr_no, String mem_no, String house_no, String rtr_no, String resr_states,
			Date resr_date, String resr_period, Double resr_hpric, Double resr_hsize, Double resr_mgt, Double resr_puc,
