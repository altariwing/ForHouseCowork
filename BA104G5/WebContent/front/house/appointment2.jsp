            ...
            <div id="${realtorVO.rtr_no}" class="rtrbar rtrName">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5">
                        <img src="<%=request.getContextPath()%>/front/tools/showimage.do?action=rtr_photo&rtr_no=${realtorVO.rtr_no}" alt="${realtorVO.rtr_name}個人照片" style="width: 180px; height: 200px;">
                    </div>
                    <div class="col-xs-12 col-sm-5">
