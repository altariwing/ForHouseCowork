	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-sm-offset-3 form_ann">
				<form role="form" METHOD="post" ACTION="<%=request.getContextPath()%>/back/promo/promo.do"
					...
					<div class="form-group">
						<label for="promo_name">優惠券數量</label> <input type="text"
							class="form-control" name="coupon_quanity"
							value="<%=(promoVO == null) ? "修改優惠券數量" : promoVO.getCoupon_quanity()%>">
					</div>
