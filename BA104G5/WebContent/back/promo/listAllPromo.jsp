...
<div class="col-xs-12 col-sm-10 maincontext">
	...
	<div class="container-fluid cooper_promo">
		<div class="row">
					...
					<tbody>
						...
						<c:forEach var="promoVO" items="${listTime}"
							...
							<tr class="col_name"
								...
								<td>
									<fmt:formatDate value="${promoVO.promo_from}" pattern="YYYY-MM-dd" />
									<br>
									~ 
									<br> 
									<fmt:formatDate value="${promoVO.promo_to}" pattern="YYYY-MM-dd" />
								</td>
								...
								<td>
									<div class="" style="height: 145.8px; width: 194px;">
										<img style="height: 145.8px; width: 194px;"
											src="<%=request.getContextPath()%>/front/tools/showimage.do?action=promo_photo&promo_no=${promoVO.promo_no}">
									</div>
								</td>
								<td>
								...
								<td>${promoVO.coupon_quanity}</td>
										
								<td>
<!-- 								coupon Conrtoller的insert -->
<%-- 							<%=request.getContextPath()%>/back/coupon/coupon.do?action=insert&promo_no=${promoVO.promo_no}&emp_no=${promoVO.emp_no} --%>
									<a class="btn btn_cooper modal_jump cooper_ann_href" href="<%=request.getContextPath()%>/back/coupon/coupon.do?action=insertaCouponFromPromo&promo_no=${promoVO.promo_no}&promo_content=${promoVO.promo_content}&cp_from=${promoVO.promo_from}&cp_to=${promoVO.promo_to}">
									產生優惠券
									</a>
								</td>
								<td>
				...
				<div class="modal-body">
					<form role="form" METHOD="post" ACTION="promo.do"
						...
						<div class="form-group">
							...
							<div class="form-group">
							<label for="promo_name">優惠券數量</label> 
							<input type="number" class="form-control" name="coupon_quanity" placeHolder="優惠券數量">
						</div>						
						...
						<div class="form-group">
							<label for="empno_no">員工編號</label>
							<input type="text" class="form-control" name="emp_no" value="${empVO.emp_no}" readonly/>
						</div>
