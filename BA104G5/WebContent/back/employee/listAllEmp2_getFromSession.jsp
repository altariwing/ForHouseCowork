...
<table id="table-1 " >
		 ...
		 <h4><a href="<%=request.getContextPath()%>/back/employee/select_page.jsp"><img src="<%=request.getContextPath()%>/images/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
