...
<table id="table-1 " >
		 ...
		 <h3>所有員工資料</h3>
		 <h4><a href="<%=request.getContextPath()%>/back/employee/select_page.jsp"><img src="<%=request.getContextPath()%>/back/employee/images/back_btn.jpg" width="150" height="50" border="0">回管理員工首頁</a></h4>
