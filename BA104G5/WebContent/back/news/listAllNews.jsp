...
<jsp:useBean id="newstypeSvc" scope="page" class="com.newstype.model.NewsTypeService" />
						...
						<c:forEach var="newsVO" items="${list}" begin="<%=pageIndex%>"
							...
							<tr class="col_name"
								...
								<td><div class="" style="height: 145.8px; width: 194px;">
										<img style="height: 145.8px; width: 194px;" class="img-thumbnail" src="<%=request.getContextPath()%>/front/tools/showimage.do?action=news_photo&news_no=${newsVO.news_no}">
									</div></td>
								<!--<td><fmt:formatDate value="${newsVO.news_date}" pattern="MM-dd"/></td>-->
								<td>${newsVO.emp_no}</td>
								<td>
									<form METHOD="post"
					...
					<form role="form" METHOD="post" ACTION="news.do"
						...
						<div class="form-group">
							<label for="news_photo">照片預覽</label> <input type="file"
								name="news_photo" onchange="readURL(this);"> 
								<img name="news_photo" id="imgpreview" class="img-thumbnail" alt="照片預覽" />
						</div>
						<div class="form-group">
