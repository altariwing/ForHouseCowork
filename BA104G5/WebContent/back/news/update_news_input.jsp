				...
				<form role="form" METHOD="post" ACTION="news.do"
					...
					<div class="form-group">
						...
						<div class="" style="height: 145.8px; width: 194px;">
							<img style="height: 145.8px; width: 194px;" class="img-thumbnail"
								src="<%=request.getContextPath()%>/front/tools/showimage.do?action=news_photo&news_no=${newsVO.news_no}">
						</div>
					</div>
					<div class="form-group">
						<label for="news_content">照片預覽</label> <input type="file"
							name="news_photo" onchange="readURL(this);"> <img
							name="news_photo" id="imgpreview" class="img-thumbnail"
							alt="照片預覽" />
					</div>
					<div class="form-group">
