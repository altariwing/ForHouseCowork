...
<div class="col-xs-12 col-sm-10 maincontext">
	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a
						href="<%=request.getContextPath()%>/back/house/house_select_page.jsp"><img
						src="<%=request.getContextPath()%>/images/Houselogo1.png"
						width="100" height="32" border="0">回房屋資料</a>
				</h4>
			</td>
		</tr>
	</table>
	...
	<FORM METHOD="post"
		...
		<table>
			...
			<tr>
				<td>其餘細項:</td>
				<td><textarea name="data_info" Cols="45" Rows="5" Wrap="off">${houseVO.data_info}</textarea></td>
			</tr>
