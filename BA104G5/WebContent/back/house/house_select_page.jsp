...
<ul>
  <li><a href='<%=request.getContextPath() %>/back/house/ListALLHouse.jsp'>List</a> all HouseInfo.  <br><br></li>
...
<ul>
  <li><a href='<%=request.getContextPath() %>/back/house/AddHouse.jsp'>Add</a> a new House.</li>
</ul>
	<!-- 一定要留住的</div> ================================================================================== -->
</div>
<!-- 一定要留住的</div> ================================================================================== -->
