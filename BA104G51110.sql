...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','KLIMPEN桌子, 灰色 淺灰色','商品詳情 : \t◆美背式設計，可放置在房間中央\t◆每個抽屜附標籤匣，方便整理及拿取收納物\t◆抽屜附防滑落裝置，可防止全開後掉落\t◆附可調式層板，可依需求調整儲物空間,商品尺寸\t長度: 120 公分\t寬度: 60 公分\t高度: 73 公分,最大承重量: 50 公斤',62,8780);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','LINNMON/ALEX 桌子, 幾何圖案 藍色, 白色','商品詳情 : \t◆桌面有幾何圖案，讓你坐著工作時不會感到眼睛疲勞\t◆蜂巢板材質，耐用又輕巧，外框部份是纖維板，整片覆蓋在密集板或實木的邊框，使用較少的原料且易搬運，可降低對環境的衝擊\t◆美背式設計，可放置在房間中央\t◆抽屜附防滑落裝置，可防止全開後掉落商品尺寸\t長度: 120 公分\t寬度: 60 公分\t高度: 74 公分',73,3890);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','MALM 書桌/工作桌, 白色','商品詳情 : \t◆桌面底下附層板，可隱藏收納電線和延長線，方便連接使用\t◆美背式設計，可放置在房間中央\t◆可依不同需求，將收納層架安裝在右側或左側\t商品尺寸:\t寬度: 140 公分\t深度: 65 公分\t高度: 73 公分\t最大承重量: 50 公斤',87,3990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','MALM L型書桌/工作桌, 棕色 實木貼皮, 梣木','商品詳情 :\t◆附外拉式側桌，可提供額外的工作空間\t◆桌面底下附層板，可隱藏收納電線和延長線，方便連接使用\t◆可依需求將外拉式桌面安裝在左側或右側\t◆美背式設計，可放置在房間中央\t商品尺寸 :\t寬度: 151 公分\t深度: 65 公分\t高度: 73 公分\t最大承重量: 50 公斤',46,3990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','PAHL 書桌/工作桌附延伸層架, 白色, 粉紅色','商品詳情 : \t◆可隨著孩子成長調整成3種高度\t◆可用桌腳的旋鈕，將高度調整成59、66或72公分\t◆前面和後面的桌腳之間有電線收納架，可放置電線和延長線\t◆可選擇綠色或白色背板朝外，搭配居家佈置風格\t商品尺寸\t寬度: 96 公分\t深度: 58 公分\t最低高度: 98 公分\t最高高度: 111 公分\t最大承重量: 50 公斤\t',59,3390);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','PAHL 書桌/工作桌附層架, 白色, 綠色','商品詳情 : \t◆可隨著孩子成長調整成3種高度\t◆可用桌腳的旋鈕，將高度調整成59、66或72公分\t◆前面和後面的桌腳之間有電線收納架，可放置電線和延長線\t◆可選擇綠色或白色背板朝外，搭配居家佈置風格\t商品尺寸 : \t寬度: 96 公分\t深度: 58 公分\t最低高度: 119 公分\t最高高度: 132 公分\t最大承重量: 50 公斤\t',61,3390);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','EKEBOL 三人座沙發, KATORP 自然色','',12,15900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','EKTORP 三人座沙發, NORDVALLA 深米','',7,13900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','LANGFJALL 旋轉椅, GUNNARED 米色, 白色','',28,4999);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','LANGFJALL 旋轉椅, GUNNARED 棕紅色, 白色','',16,4999);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','MARKUS 旋轉椅, GLOSE 黑色 ROBUST 黑色','',15,4990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','SPORREN 旋轉椅, 白色, VISSLE 淺藍色','',23,1799);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','STRANDMON 扶手椅, GILLHOV 彩色','',38,7990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','HURDAL 寢具櫃, 綠色','',4,11900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','KALLAX 層架組, 灰色, 木紋','',19,2695);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','KALLAX-黑棕色 層架組附門片','',26,2895);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','LIXHULT 收納組合, 紅色, 藍色','',23,11900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','PAX 衣櫃/衣櫥, 染白橡木紋, FARVIK 白色玻璃','',3,30600);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','STUVA 衣櫃/衣櫥, 白色, 藍色','',10,5690);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','STUVA 衣櫃/衣櫥, 白色, 粉紅色','',14,5690);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000002','好摺凳','折凳的奧妙之處，就是可以藏在民宅之中，隨手可得，還可以坐著它來隱藏殺機，打完更可以坐下休息，就算被條子捉到也告不了你，真不愧為七大武器之首！',1,8888);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000001','武士專用:圓桌','低調古典，可以體驗歐洲武士開會時之情境',1,299900);
...
INSERT INTO REPORTPRODUCT (RP_NO,MEM_NO,PRD_NO,EMP_NO,RP_REASON,RP_RESULT,RP_STATE) VALUES ('RP'||(LPAD(TO_CHAR(RP_SEQ.NEXTVAL),8,'0')),'MB00000001','PD00000021','EM00000002','好摺凳是武器，不是傢俱啊~','該物件有觸犯法律之嫌，予以下架處理','已結案');
INSERT INTO REPORTPRODUCT (RP_NO,MEM_NO,PRD_NO,RP_REASON,RP_STATE) VALUES ('RP'||(LPAD(TO_CHAR(RP_SEQ.NEXTVAL),8,'0')),'MB00000001','PD00000022','武士的圓桌不存在這世界啊!','處理中');
--------------------------------
...
VALUES('OD171111-000001', 'PD00000020', 500000000 ,10);
INSERT INTO ORDER_DETAIL(PDO_NO, PRD_NO, ODER_UNI_PRICE, ODER_QUANTITY) 
VALUES('OD171111-000001', 'PD00000011', 500000000 ,10);
COMMIT;
