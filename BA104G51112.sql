...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000002','好摺凳','好折凳！\n折凳的奧妙之處，是可以藏於民居之中，隨手可得，還可以坐著它掩藏殺機。\n就算被警察抓也告不了你，真不愧為七種武器之首！',1,8888);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000001','歐洲武士開會專用:圓桌','圓桌武士的精神: \n◆永不暴怒和謀殺\n◆永不背叛\n◆決不殘忍，給予請求寬恕者以寬恕\n◆總是給予女士以援助\n◆永不脅迫女士\n◆永不因為愛或言辭之利捲入爭吵而戰鬥。',1,299900);
