...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','PAHL 書桌/工作桌附延伸層架, 白色, 粉紅色',59,3390);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','PAHL 書桌/工作桌附層架, 白色, 綠色',61,3390);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','SPORREN 旋轉椅, 白色, VISSLE 淺藍色',23,1799);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','STRANDMON 扶手椅, GILLHOV 彩色',38,7990);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','STUVA 衣櫃/衣櫥, 白色, 藍色',10,5690);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','STUVA 衣櫃/衣櫥, 白色, 粉紅色',14,5690);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000002','好摺凳','好折凳！<br>折凳的奧妙之處，是可以藏於民居之中，隨手可得，還可以坐著它掩藏殺機。<br>就算被警察抓也告不了你，真不愧為七種武器之首！',1,8888);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_DESC,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000001','歐洲武士開會專用:圓桌','圓桌武士的精神: <br>◆永不暴怒和謀殺<br>◆永不背叛<br>◆決不殘忍，給予請求寬恕者以寬恕<br>◆總是給予女士以援助<br>◆永不脅迫女士<br>◆永不因為愛或言辭之利捲入爭吵而戰鬥。<br>想要體驗，趕快購買',1,299900);
...
INSERT INTO ORDER_DETAIL(PDO_NO, PRD_NO, ODER_UNI_PRICE, ODER_QUANTITY) 
VALUES('OD'||TO_CHAR(SYSDATE,'RRMMDD')||'-000001', 'PD00000011', 500000000 ,10);
COMMIT;
