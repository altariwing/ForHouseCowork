...
INSERT INTO MEMBER (MEM_NO,MEM_ID,MEM_PSW,MEM_NAME,MEM_ADDR,MEM_GAME,SEARCH_STATE,LOCK_STATE) VALUES ('MB'||(LPAD(to_char(MEM_SEQ.NEXTVAL),8,'0')),'peterwu@gmail.com','123456','彼得吳','台北市大安區中大路8號',1,'ON','ON');
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','KLIMPEN桌子, 灰色 淺灰色',62,8780);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','LINNMON/ALEX 桌子, 幾何圖案 藍色, 白色',73,3890);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000001','MALM L型書桌/工作桌, 棕色 實木貼皮, 梣木',46,3990);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','EKEBOL 三人座沙發, KATORP 自然色',12,15900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','EKTORP 三人座沙發, NORDVALLA 深米',7,13900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','LANGFJALL 旋轉椅, GUNNARED 米色, 白色',28,4999);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','LANGFJALL 旋轉椅, GUNNARED 棕紅色, 白色',16,4999);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000002','MARKUS 旋轉椅, GLOSE 黑色 ROBUST 黑色',15,4990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','HURDAL 寢具櫃, 綠色',4,11900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','KALLAX 層架組, 灰色, 木紋',19,2695);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','KALLAX-黑棕色 層架組附門片',26,2895);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','LIXHULT 收納組合, 紅色, 藍色',23,11900);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000001','PC00000003','PAX 衣櫃/衣櫥, 染白橡木紋, FARVIK 白色玻璃',3,30600);

------ 歐德 (SL00000002) 16~21 ---
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000002','PC00000001','Bernice-凱希4.9尺多功能旋轉桌工作桌(胡桃色)',21,8856);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000002','PC00000001','Cest Chic - Goody樂讀機能桌櫃組',18,9800);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000002','PC00000002','INGATORP 餐椅, 黑色, Nolhaga 灰米色',46,3290);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000002','PC00000003','NEFLAS時間旅人二抽一門電視收納櫃',12,4230);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000003','PC00000001','Homelike 超值小巧 L型電腦桌-深40cm-純白色',92,2399);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000003','PC00000002','幸福時光 氣壓棒自動無段式調整沙發床/椅',66,5990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000003','PC00000003','JP Kagu 日系薄型時尚角落電視收納櫃-黑色',25,10800);
...
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000001','PAHL 書桌/工作桌附延伸層架, 白色, 粉紅色',59,3390);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000001','PAHL 書桌/工作桌附層架, 白色, 綠色',61,3390);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000002','SPORREN 旋轉椅, 白色, VISSLE 淺藍色',23,1799);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000002','STRANDMON 扶手椅, GILLHOV 彩色',38,7990);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000003','STUVA 衣櫃/衣櫥, 白色, 藍色',10,5690);
INSERT INTO PRODUCT(PRD_NO,SLR_NO,CATE_NO,PRD_NAME,PRD_STOCK,PRD_PRICE) VALUES('PD'||(LPAD(TO_CHAR(PD_SEQ.NEXTVAL),8,'0')),'SL00000004','PC00000003','STUVA 衣櫃/衣櫥, 白色, 粉紅色',14,5690);
...
VALUES('OD'||TO_CHAR(SYSDATE,'RRMMDD')||'-'||(LPAD(TO_CHAR(PDO_NO_SEQ.NEXTVAL),6,'0')), 'MB00000002', 'SL00000002' ,'已出貨');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT)
...
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT)
VALUES('OD'||TO_CHAR(SYSDATE,'RRMMDD')||'-'||(LPAD(TO_CHAR(PDO_NO_SEQ.NEXTVAL),6,'0')), 'MB00000002', 'SL00000003' ,'已出貨');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT)
